...
function ArrowButton({
  ...
  return (
    ...
    >
      <Icon
        name={direcao === "left" ? "chevron-left" : "chevron-right"}
  ...
  if (!foto) {
    return (
      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f]">
        <Icon name="motorcycle" className="h-12 w-12 text-muted" />
      </div>
    );
  }
      ...
      <div className="flex flex-1 flex-col p-[18px] pt-4">
        ...
        <div className="mb-3 flex flex-col gap-[5px]">
          <div className="flex items-center gap-1.5 text-xs text-muted">
            <Icon name="gauge" className="h-3.5 w-3.5 shrink-0" />
            {formatKm(moto.km)}
          </div>
          {moto.specs.cor && (
            <div className="flex items-center gap-1.5 text-xs text-muted">
        ...
        <div className="mt-auto flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-between">
          <div>
          ...
          <a
            className="inline-flex shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-lg bg-green px-3 py-[9px] text-xs font-bold text-white transition-opacity hover:opacity-[0.88]"
            href={linkWpp}
            target="_blank"
            rel="noreferrer"
          >
            <Icon name="whatsapp" className="h-[15px] w-[15px] shrink-0 fill-white" />
            Quero saber mais
          </a>
        </div>
      </div>
